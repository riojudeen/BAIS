...
<div class="row ">
	...
	<div class="col-md-12 ">
		...
		<div class="card">
			<div class="card-header">
				<h5 class="title pull-left">Database Kalender Kerja</h5>
                    ...
                    <table class="table table-bordered table_org" id="uangmakan" cellspacing="0" width="100%">
                        ...
                        if(mysqli_num_rows($sqlWS) > 0){
                            ...
                            <tr>
                                ...
                                <td rowspan="<?=$totalWS?>"><?=$dataWS['code_name']?></td>
                                <?php
                                ...
                                while($shift_ = mysqli_fetch_assoc($sqlS)){
                                    ...
                                    foreach($array_tgl AS $tgl_){
                                        ...
                                        $color = (mysqli_num_rows($sqlHolidays) > 0)?"bg-warning":""
                                        ?>
                                         
                                        <td class="text-center <?=$color?>">X</td>
                                        <?php   
                                    }
                                    ?>
