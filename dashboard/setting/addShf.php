...
<?php
    ...
    <script type="text/javascript">
        ...
        $(".add-more").click(function(e){
            ...
            html += '<input type="text" name="shift[]" class="form-control" placeholder="Shift" required ';
            html += '<label>Production Shift</label>';
            html += '<select name="production[]" id="" class="form-control">';
