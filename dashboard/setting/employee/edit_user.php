                ...
                <div class="card ">
                    ...
                    <div class="card-body ">
                        <form method="post" action="proses/proses.php" class="form-horizontal">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-check-radio">
                                        <label class="form-check-label">
                                            <input class="form-check-input bg-primary" type="radio" name="passactive[]" id="passactive<?=$no?>" value="old" checked="">
                                            Gunakan password lama
                                            <span class="form-check-sign"></span>
                                        </label>
                                    </div>
                                    <div class="form-group">
                                        <input type="password"  id="pass2<?=$no?>" value="......" readonly class="form-control">
                                        <input type="hidden" name="pass1[]" id="pass2<?=$no?>" value="<?=$dataUser['pass']?>" class="form-control pass1" 
                                            data-id="<?=$no?>">
                                ...
                                <div class="col-sm-5 pl-0">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="password"
                                                name="pass2[]" id="pass2<?=$no?>" class="form-control pass2 passw" data-id="<?=$no?>" placeholder="ganti password disini...">
                            ...
                            <div class="row">
                                <div  class="col-sm-12">
                                    <button class="btn btn-success pull-right" type="submit" name="edituser">
                                        Save
                                    </button>
                                </div>
...
<?php
    ...
    }else if(isset($_POST['userchecked'])){
        include("mass_edit.php");
    }else{
