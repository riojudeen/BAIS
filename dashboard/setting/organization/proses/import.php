...
use PhpOffice\PhpSpreadsheet\Reader\Xlsx;
    ...
    if(isset($_FILES['file_import']['name']) && in_array($_FILES['file_import']['type'], $file_mimes)) {
        ...
        if($_POST['part'] == 'division'){
            $sql = "INSERT INTO `division`(`id_div`, `nama_divisi`, `npk_cord`, `id_company`, `part`) VALUES "; 
        }else if($_POST['part'] == 'deptAcc'){
            $sql = "INSERT INTO `dept_account`(`id_dept_account`, `department_account`, `npk_dept`, `id_div`, `part`) VALUES "; 
        }else if($_POST['part'] == 'section'){
            $sql = "INSERT INTO `section`(`id_section`, `section`, `npk_cord`, `id_dept`, `part`) VALUES "; 
        }else if($_POST['part'] == 'dept'){
            $sql = "INSERT INTO `department`(`id_dept`, `dept`, `npk_cord`, `id_div`, `part`) VALUES"; 
        }else if($_POST['part'] == 'group'){
            $sql = "INSERT INTO `groupfrm`(`id_group`, `nama_group`, `npk_cord`, `id_section`, `part`) VALUES "; 
        }else if($_POST['part'] == 'pos'){
            $sql = "INSERT INTO `pos_leader`(`id_post`, `nama_pos`, `npk_cord`, `id_group`, `part`) VALUES "; 
        }else{
