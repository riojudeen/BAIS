            ...
            <form action="proses/prosesMaster.php" method="POST">
			    <div class="card-body">
                    ...
                    <div class="control-group after-add-more data-add-1" data-id="1">
                        ...
                        <input type="text" name="jbt[]" class="form-control" placeholder="nama jabatan " required >
                        <label>Level</label>
                        <input type="number" name="lvl[]" class="form-control" pattern="[0-9]{1,3}" placeholder="diisi dengan angka" required >
                        <br>
                    </div>
                </div>
                <hr>
...
<?php
    ...
    <script type="text/javascript">
        ...
        $(".add-more").click(function(e){
            ...
            html += '<label>Kode Jabatan</label>';
            html += '<input type="text" name="code[]" class="form-control" maxLength="5" placeholder="maximum 5 karakter (ex. ABC001 etc...)" required >';
            html += '<label>Nama Jabatan</label>';
            html += '<input type="text" name="jbt[]" class="form-control" placeholder="nama jabatan " required >';
            html += '<label>Level</label>';
            html += '<input type="number" name="lvl[]" class="form-control" pattern="[0-9]{1,3}" placeholder="diisi dengan angka" required >';
