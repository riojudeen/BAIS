            ...
            <div class="card-body ">
                <form method="post" action="proses/proses.php" class="form-horizontal">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" value="<?=$dMp['nama']?>" name="nama[]" id="nama<?=$no?>" class="form-control nama" placeholder="Nama Lengkap"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <input type="text"  id="tgl_masuk<?=$no?>" name="tgl_masuk[]" id="tgl_masuk" data-date-format="DD-MM-YYYY" class="form-control datepicker tgl_masuk"
                                    value="<?= tgl_database($dMp['tgl_masuk'])?>" data-id="<?=$no?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <select name="deptAcc[]" id="deptAcc<?=$no?>" class="form-control deptAcc" data-id="<?=$no?>" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <select name="shift[]" id="shift<?=$no?>" class="form-control shift" title="Pilih Jabatan" required data-id="<?=$no?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <select name="jabatan[]" id="jabatan<?=$no?>" class="form-control jabatan" title="Pilih Jabatan" required data-id="<?=$no?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <select name="status[]" id="status<?=$no?>" class="form-control status" title="Pilih Jabatan" required data-id="<?=$no?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                            <select name="dept[]" id="dept<?=$no?>" class="form-control dept" title="Pilih Jabatan" required data-id="<?=$no?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <select name="sect[]" id="sect<?=$no?>" class="form-control sect" data-size="7"
                                    data-style="btn btn-primary" title="Department" required data-id="<?=$no?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <select name="group[]" id="group<?=$no?>" class="form-control group" data-size="7"
                                    data-style="btn btn-primary" title="group" required data-id="<?=$no?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <select name="pos[]" id="pos<?=$no?>" class="form-control pos" data-size="7"
                                    data-style="btn btn-primary" title="group" required data-id="<?=$no?>">
