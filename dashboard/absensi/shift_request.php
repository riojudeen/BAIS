...
if(isset($_SESSION['user'])){
                                ...
                                <div class="nav-tabs-wrapper">
                                    <ul id="tabs" class="nav nav-tabs flex-column nav-stacked text-left" role="tablist">
                                        ...
                                        <li class="nav-item ">
                                            ...
                                            <a class="btn btn-sm btn-link btn-round btn-info org navigasi-absensi active data-active"  data-toggle="tab" data-id="shift" href="#result" role="tab" aria-expanded="true"></i>Pengajuan Shift</a>
                                        </li>
                                        <li class="nav-item ">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $(document).on('click','.shift_req',function(){
                var id = $(this).attr("id");
                
                $.ajax({
                    url: 'ajax/modal_shift.php',
                    method: 'post',
                    data: {id:id},		
                    success:function(data){		
