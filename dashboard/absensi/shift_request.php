                            ...
                            <div class="sticker">
                                ...
                                <div class="nav-tabs-wrapper">
                                    <ul id="tabs" class="nav nav-tabs flex-column nav-stacked text-left" role="tablist">
                                        <!--  -->
                                        <li class="nav-item ">
                                            <a class="btn btn-sm btn-link btn-round btn-info org navigasi-overtime active data-active"  data-toggle="tab" data-id="req" href="#result" role="tab" aria-expanded="true">Add Request</a>
                                        </li>
                                        <li class="nav-item ">
                                            <a class="btn btn-sm btn-link btn-round btn-info org navigasi-overtime"  data-toggle="tab" data-id="success" href="#success" role="tab" aria-expanded="true">Request Monitoring</a>
                                        </li>
