        ...
        <div class="card " >
            <div class="card-header ">
                ...
                <div class="pull-left ">
                    ...
                    <h4 class="card-title " >Karyawan Sakit / Rawat Inap</h4>
                    <p class="card-category ">karyawan tidak masuk dengan surat dokter / sakit</p>
                </div>
                
                <p class="box pull-right ">
                
                    <button class="btn btn-link btn-round btn-outline-primary" type="button" data-toggle="collapse" data-target="#sakit" aria-expanded="false" aria-controls="sakit">
