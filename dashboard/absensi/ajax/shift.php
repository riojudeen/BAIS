...
if(isset($_GET['id'])){
    ...
    if($_GET['id'] == 'shift'){
     ...
     $add_filter_monitor = " AND shift_req = '1' ";
                                ...
                                <tr >
                                    ...
                                    <td class="td">
                                        <div class="progress" style="border-radius: 50px; width: 100px; height: 20px; margin: 0px">
                                            <div class="progress-bar progress-bar-animated progress-bar-<?=$clr?> progress-bar-striped" role="progressbar" style="width: <?=$prs?>%" aria-valuenow="<?=$prs?>" aria-valuemin="0" aria-valuemax="100"></div><?=$stt?>
                                        </div>
                                    </td>
                                    <td class="text-right">
