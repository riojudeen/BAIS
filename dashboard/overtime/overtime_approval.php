        ...
        <div class="col-md-12">
            <div class="card" >
                <div class="card-header">
                    <div class="row">
                        <h5 class="title pull-left col-md-6" id="mainpage"> Overtime Approval</h5>
                            ...
                            <div class="sticker">
                                ...
                                <div class="nav-tabs-wrapper">
                                    <ul id="tabs" class="nav nav-tabs flex-column nav-stacked text-left" role="tablist">
                                        <!--  -->
                                        <li class="nav-item ">
                                            <a class="btn btn-sm btn-link btn-round btn-info org navigasi-overtime active data-active"  data-toggle="tab" data-id="datareq" href="#result" role="tab" aria-expanded="true">Data Request</a>
                                        </li>
                                        <li class="nav-item ">
                                            <a class="btn btn-sm btn-link btn-round btn-info org navigasi-overtime"  data-toggle="tab" data-id="breakdown" href="#breakdown" role="tab" aria-expanded="true">Data Break Down</a>
                                        </li>
