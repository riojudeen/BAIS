        ...
        <div class="card " >
            <div class="card-header ">
                ...
                <div class="pull-left ">
                    ...
                    <h4 class="card-title " >Karyawan Mangkir / Tidak Absen</h4>
                    <p class="card-category ">Karyawan tidak absen tanpa pemberitahuan</p>
                </div>
                
                <p class="box pull-right ">
                
                    <button class="btn btn-link btn-round btn-outline-primary" type="button" data-toggle="collapse" data-target="#mangkir" aria-expanded="false" aria-controls="mangkir">
                        ...
                        <div class="table-responsive" >
                            <table class="table table-striped">
                                ...
                                <tbody class="text-uppercase">
                                    ...
                                    WHERE absensi.date BETWEEN '$tanggalAwal' AND '$tanggalAkhir' AND (absensi.ket = 'TL' OR absensi.ket = 'M') AND $clm = '$access_' ")or die(mysqli_error($link));
                                    $no = 1;
