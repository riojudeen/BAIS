...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-12 col-lg-4 mx-auto">
			<center>
				<a href="index.php"><img src="gambar/sistem/tuwekkantai.png" style="width:auto; height: 150px;"></a>
			</center>
			<br>
			...
			<div class="">
				...
				<form action="daftar_aksi.php" method="post">
					...
					<div class="form-group">
						<label>NPK</label>
						<input type="number" name="email" class="form-control" required='required' autocomplete="off" placeholder="Masukkan email ..">
					</div>
